...
export function TimelineRoad() {
  const items: {
    ...
    {
      date: "2025.06",
      label: "GitHub Pages (첫 배포)",
      targetId: "sec-github",
      href: "https://kyung-bok.github.io/",
    },
    {
      date: "2025.07",
      label: "Bok Project (리액트 첫 배포)",
      targetId: "sec-bok",
    ...
    },
    {
      ...
      label: "OZFLIX (무한스크롤)",
      targetId: "sec-ozflix",
      href: "https://ozfilx.vercel.app",
    },
    {
      date: "2025.09",
      label: "OZ Shop (커머스)",
      targetId: "sec-ozshop",
      href: "https://ozshop-kappa.vercel.app",
    },
    {
      date: "2025.10",
      label: "Wizards of Oz (소개)",
      targetId: "sec-wiz",
